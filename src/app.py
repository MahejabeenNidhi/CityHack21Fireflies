...
app.layout=html.Div(style={"backgroundColor":"black"},children=[
    ...
    html.Div(className="page_header",children=[
        ...
        html.Img(src="./assets/covicheckLogo.jpeg",height="50px",style={'display': 'inline-block',"margin-top": "1%","margin-right": "1%"}),
        html.Div(children=[html.H1("CoviCheck ")],style={'display': 'inline-block',}),]),
    ...
    #Left Column
    html.Div(children=[
        html.Div(style={"border":"5px black solid","margin":"0"},children=[
            html.H3("Latest Situation"),
